		...
		<div className="min-h-screen bg-gradient-to-b from-pink-100 to-purple-100">
			...
			<main className="container mx-auto px-4 py-8 ">
				<section id="sobre" className="mb-16">
					<h2 className="text-4xl font-bold text-purple-800 mb-6 prose">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						<div className="order-2 md:order-1 prose">
							...
							<p className="mb-4">
								Acredito que cada criança é única e merece ser tratada de
								maneira individualizada, respeitando suas necessidades e
								particularidades. Por isso, meu trabalho é baseado em uma
								abordagem humanizada e centrada na criança, buscando sempre
								compreender suas emoções e pensamentos para poder ajudá-las da
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
								<div>
									...
									<ul className="list-disc pl-6 mb-4 prose">
										<li>
											O consultório fica localizado no Edifício Golden Office,
											na cidade de Jundiaí/SP.
										</li>
										<li>
											A sala é equipada com materiais psicopedagogicos,
											brinquedos, livros, e diversos outros recursos que são
											utilizados em nossos atendimentos!
										</li>
										<li>
											O espaço possui uma recepção com cantinho do café, para
											que as famílias possam esperar em um local aconchegante!
										</li>
										<li>
											Também possuímos banheiro e uma pequena copa, utilizada
											também como recurso de algumas terapias!
										</li>
									</ul>
									<p className="font-semibold prose">
						...
						<CardContent className="p-6 flex flex-col justify-center items-center">
							...
							<div className="flex flex-col justify-center">
								<a href="https://api.whatsapp.com/send?phone=5511914175676">
									<Button className="bg-purple-600 hover:bg-purple-700 text-white h-10 md:w-96">
										Agende uma consulta
									</Button>
								</a>
